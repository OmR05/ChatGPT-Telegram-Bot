...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "5833576895:AAG681FTzt9ce8UrPsHXIJpCkfLuDTnecFw"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'Animos Prime'
username = '@AnimosPrime_bot'
